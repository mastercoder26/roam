...
final class CarPlaySceneDelegate: NSObject, CPTemplateApplicationSceneDelegate {
    ...
    private func refreshDashboard() {
        dashboard?.title = driveSession.isRecording ? "Drive in progress" : "Swerve"
    ...
    private var dashboardItems: [CPInformationItem] {
        guard driveSession.isRecording else {
            return [
                ...
                CPInformationItem(title: "Start a drive", detail: "Use the Swerve app on iPhone before leaving")
            ]
        }
