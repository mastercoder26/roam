...
enum DriverReadinessEngine {
        ...
        guard demand.available else {
            return DriverReadinessInsight(
                ...
                evidence: DriverReadinessEvidence(
                    ...
                    collectionNote: "Swerve leaves unavailable route data out rather than estimating it."
                )
            )
        }
        ...
        guard behavior.recentMeasuredMiles >= configuration.minimumRecentQualityMiles,
            ...
            return DriverReadinessInsight(
                ...
                evidence: DriverReadinessEvidence(
                    ...
                    collectionNote: "Rates use Swerve’s existing braking, acceleration, cornering, and phone-motion coaching events."
                )
            )
        }
    ...
    private static func historyInsight(
        ...
        return DriverReadinessInsight(
            ...
            detail: "\(recordText). Swerve needs more repeated, trace-backed driving before comparing this route with confidence.",
            state: .informational,
            evidence: DriverReadinessEvidence(
                source: .gpsMotion,
                recordedValue: recordText,
