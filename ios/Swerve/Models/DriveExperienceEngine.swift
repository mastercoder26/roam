...
/// quantities already measured by Swerve; it does not infer road type,
...
struct DriveTraceQuality: Codable, Hashable {
    ...
    /// Ratio of continuous-trace distance to Swerve's saved score distance.
...
/// Counts of Swerve's existing coaching events. These remain observations for
