...
struct PracticeGoal: Identifiable, Codable, Hashable {
    ...
    var coachingText: String {
        switch kind {
        case .buildRecordedHistory:
            return "Record manual drives with usable GPS and motion on different days. Practice with an adult until Swerve has enough measured history to compare routes."
        case .routeDemand:
            return "Practice this route demand with an adult. Start and end a manual drive so Swerve can measure the part of the route you covered."
        case .routeFamiliarity:
            return "Practice the route with an adult from start to finish. Swerve only recognizes continuous, directionally aligned GPS coverage."
        case .drivingQuality:
...
enum PracticeDriveDebriefOutcome: String, Codable, Hashable {
    ...
    var summary: String {
        switch self {
        case .verifiedRoutePractice:
            return "This drive followed enough of the planned route for Swerve to use its measured coverage as practice evidence."
        case .partialRouteCoverage:
            return "Swerve measured part of the planned route. A more complete continuous pass can strengthen the practice record."
        case .insufficientGPSCoverage:
            return "Swerve could not verify enough continuous GPS coverage of the planned route on this drive."
        case .savedNotYetQualifying:
