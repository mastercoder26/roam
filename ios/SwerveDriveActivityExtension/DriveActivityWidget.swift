...
@main
struct SwerveDriveActivityWidgetBundle: WidgetBundle {
    var body: some Widget {
        SwerveDriveActivityWidget()
    }
}

struct SwerveDriveActivityWidget: Widget {
        ...
        ActivityConfiguration(for: DriveActivityAttributes.self) { context in
            ...
            DynamicIsland {
                DynamicIslandExpandedRegion(.leading) {
                    Label("Swerve", systemImage: "steeringwheel")
                        .foregroundStyle(.blue)
                }
